...
fun <N : Number> N.dip2px(): Float {
    return this.dip2px(AppManager.getContext())
}
...
fun <N : Number> N.px2dip(): Float {
    return this.px2dip(AppManager.getContext())
}
...
fun <N : Number> N.sp2px(): Float {
    return this.sp2px(AppManager.getContext())
}
...
fun <N : Number> N.px2sp(): Float {
    return this.px2sp(AppManager.getContext())
}
